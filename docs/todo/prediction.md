...
class ExplanationBuilder:
    ...
    Output bằng ngôn ngữ tự nhiên theo ngôn ngữ người dùng.
    """
...
│       │   ├── risk_scorer.py
│       │   ├── blast_radius.py
│       │   └── explanation_builder.py # ExplanationBuilder → multilingual narrative
│       │
│       ├── suppression/
...
| 3 | `ExplanationBuilder` (P1: per-type multilingual narrative cho DISK_FULL, MEMORY_PRESSURE, CPU_ANOMALY, MEMORY_ANOMALY, HTTP_ERROR_SPIKE, CPU_ACCELERATION, HTTP_ERROR_ACCELERATION) | ✅ |
...
> - ExplanationBuilder P2: narrative đa ngôn ngữ đầy đủ gồm signature + blast radius ✅
